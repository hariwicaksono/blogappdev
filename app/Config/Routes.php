...
$routes->delete('api/setting/(:segment)',   'Setting::delete/$1');
...
$routes->delete('api/category/(:segment)',   'Category::delete/$1');
...
$routes->delete('api/comment/(:segment)',   'Comment::delete/$1');
...
$routes->get('api/search/(:segment)',      'Search::show/$1');
...
$routes->delete('api/slideshow/(:segment)',   'Slideshow::delete/$1');
$routes->put('api/slideshowimage/(:segment)',      'SlideshowImage::update/$1');
$routes->get('api/tag/(:segment)',      'Tag::show/$1');
...
$routes->delete('api/user/(:segment)',   'User::delete/$1');
